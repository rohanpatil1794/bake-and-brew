            ...
            {site.socials.map((social) => (
              <li key={social.label}>
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-cream/20 text-cream/80 transition-colors duration-200 hover:border-caramel hover:text-caramel"
                >
